...
standing**. Every duel gets its own arena, so any number of fights can run at once.
...
**Companions:** every duel is a **pure 1v1**. Your companions stand down the moment the stakes
lock in ("Sir X stands down - a duel is fought alone") and rejoin you when it's over; nobody's
bodyguards can interfere, and you can't summon one mid-fight. (Companions are never part of the
stake and drop nothing.)
...
- **Draws are real** - if you both fall on the same tick, or the fight hits the
