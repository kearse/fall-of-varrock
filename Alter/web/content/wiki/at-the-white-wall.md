...
5. **Inspect the front** - Three places, in any order: the White Knight line at the checkpoint, the supply road just inside the north gate, and the field north of the fence beyond the checkpoint (a safe vantage - the wilderness proper starts further north). There is nothing to click here: **walk onto each place and you read it**. Your guidance marker sits on whichever one you have not read yet and moves on to the next as you go, and the chat names the ones still outstanding. Each one tells you something; together they tell you why nobody moves.
