...
summary: Thirteen waves beneath the lava ending in TzKal-Zuk. Sacrifice a Fire cape to enter. The Infernal cape cannot be bought - only earned.
order: 3
updated: 2026-07-06
infobox: Type = Solo wave arena (private instance); Entry = Sacrifice a Fire cape to TzHaar-Ket-Keh (one-time, permanent), then talk to him (or `::inferno`); Practice = `::zuk` (Zuk only, no rewards); Exit = `::leaveinferno`; Waves = 13; Supplies = Bring your own; Reward = Infernal cape + 400 Boss tickets (partial runs pay 10/wave) + 1/1,000 TzRek-Zuk pet; Death = Safe
---
...
- `::zuk` - **practice mode**: skip straight to TzKal-Zuk. No rewards, pure reps.
...
Jad inside it. Each layer separately, then together. Expect the Inferno to end many, many runs - that's what the cape means.
