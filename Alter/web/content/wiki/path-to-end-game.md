...
Prices and shops in full: [Shops directory](/wiki/shops-directory).
...
The three war-forged sets are the best armour in the game, and the [Royal Smith](/wiki/war-forging) by the castle wall is the only maker. Bodies and legs cost 25 Commendations + 20 runite bars + 250,000 gp on top of the base item; helms take a Warden's ember instead of the heavier bill.
...
**Torva has a second source:** [Nex](/wiki/bosses-overview) drops each finished piece directly at **1/450**. Finished war-forged pieces are fully tradeable — a fat purse skips the march.
...
The **Armadyl godsword** has faster routes: **15,000 Blood Money** at the Emblem Trader, a **1/14** roll in the [LMS](/wiki/last-man-standing) champion's crate, and elite PK bots carry one — it can land in a [loot key](/wiki/wilderness-loot-keys). The **Ancient godsword** is 20,000 BM, or forge it from Nex's ancient hilt.

## Dragon claws

The most generously sourced spec weapon in the game — pick your grind:

| Source | Rate / price |
| --- | --- |
| **Karn the Red**, the named captain in occupied Varrock's [war campaign](/wiki/marches-and-the-reconquest) | **1/8** per kill, broadcast realm-wide |
| LMS champion's crate | 1/10 |
...
- **Dragon warhammer** — the named captain **Grimjaw** drops it **1/8**, or 10,000 BM at the Emblem Trader.
...
- **Abyssal whip** — Abyssal Sire (with the abyssal dagger and bludgeon), 3,000 BM, or the LMS crate.
...
- **Torture, anguish, blood fury, the DT2 rings, ferocious gloves, lightbearer** — Armoury tickets (see the [shops directory](/wiki/shops-directory)).
...
So nobody wastes a grind chasing ghosts: the **Korasi sword**, **Virtus robes**, and **3rd age / gilded** gear currently have **no source** — no drop, no shop, no recipe. The **tormented bracelet** is loot-key-only for now (mage bots wear it). When these get real sources, this page will say so.
