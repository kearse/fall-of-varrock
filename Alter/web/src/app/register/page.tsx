...
const BULLETS = [
  ...
  {
    title: "Live hiscores",
    body: "Your levels, ranks and PK record tracked from your very first kill.",
  },
  {
    title: "War campaigns and companions",
    body: "March on the occupied cities and recruit levelable AI fighters to your side.",
  },
];
        ...
        <div className="relative hidden overflow-hidden lg:block">
          ...
          <div className="relative flex h-full flex-col justify-center p-12 xl:p-16">
            ...
            <p className="mt-4 max-w-md text-lumbridge-parchment/70">
              Varrock has fallen and the kingdom bleeds. Every sword, spell and
              supply run brings the reclamation one step closer.
            </p>
