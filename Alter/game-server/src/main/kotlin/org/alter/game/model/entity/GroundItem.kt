...
class GroundItem private constructor(val item: Int, var amount: Int, internal var ownerUID: PlayerUID?) : Entity() {
    ...
    /**
     * Per-item overrides for the cycle counts at which an owned item goes public and at which
     * it despawns (both measured from spawn). -1 = use the world-wide defaults from the game
     * context. Death-reclaim piles use these to stay victim-owned far longer than normal drops.
     */
    var publicDelayOverride = -1
    var despawnDelayOverride = -1
