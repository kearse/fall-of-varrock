...
class Server {
    ...
    fun startGame(
        ...
        // Surface any plugins that threw during load (and were therefore dropped) as a
        // loud, actionable summary — otherwise the failure is a single stdout line that
        // scrolls away and the content silently does nothing in-game.
        world.plugins.reportFailures()
