...
/**
 * Returns the [SkillJingles] entry for the given [skillId], or null if none is defined.
 */
fun getSkillJingle(skillId: Int): SkillJingles? = SkillJingle.firstOrNull { it.first == skillId }?.second
