...
object FirstMarch : QuestDefinition(
    ...
    private suspend fun QueueTask.brief(p: Player) {
        ...
        zo(p, "You held the east camp this morning.")
        me(p, "I did.")
        zo(p, "Then you've seen what a defence looks like. Men in a line, waiting to be hit.")
        zo(p, "Now see the other half.")
        me(p, "The other half?")
        zo(p, "The March. Every half hour, ten Knights of Lumbridge walk out of this courtyard and hit something that deserves it. A camp. A road. A rogue position.")
