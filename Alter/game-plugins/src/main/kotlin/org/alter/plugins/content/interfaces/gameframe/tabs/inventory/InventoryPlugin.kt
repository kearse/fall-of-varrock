            ...
            if (slot != null) {
                ...
                when (option) {
                    ...
                    10 -> {
                        ...
                        if (option != null) {
                            /*
                             * The client sends inventory item options as ClickOpN where the
                             * item's first interface option (index 0, e.g. "Eat") arrives as
                             * op 2. `onItemOption` binds handlers at interfaceOption-index + 1
