...
object TeleportRegistry {
    ...
    val all: List<TeleportDestination> = listOf(
        ...
        // Team 4 minigames B (wiki-spec): the Temple of the Eye lobby and the Blast Furnace room.
        built("guardians_of_the_rift", "Guardians of the Rift", MINIGAMES, Tile(3613, 9478, 0), SAFE_ZONE),
        built("blast_furnace", "Blast Furnace", MINIGAMES, Tile(1940, 4958, 0), SAFE_ZONE),
