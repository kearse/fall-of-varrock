...
object EquipmentStats {
    ...
    fun Player.bonusTextMap(): List<String> {
        ...
        return listOf(
            ...
            // "Base"/"Actual" have no backing system on this server; show honest neutrals
            // rather than fabricated numbers. Adjust once their intended meaning is set.
            "Base: ${formatBonus(0)}",
            "Actual: ${formatBonus(0)}",
            ...
            // No salve/black-mask damage effects are wired into the combat formula, so the
            // honest effective bonus is 0% (showing a multiplier would misstate real damage).
            "Undead: +0%",
            "Slayer: +0%"
        )
    }
