...
class DonorStorePlugin(
    ...
    init {
        ...
        // Donor cosmetics are tradeable so they can change hands between players, but never through
        // an NPC gp conversion (alch / Trading Post / General Store) — the audit's guard rule.
