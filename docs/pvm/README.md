...
| 10 | `pvm/10-minigames-b` | Tempoross, Guardians of the Rift, Giants' Foundry, Blast Furnace, Barbarian Assault | OSRS wiki | ⬜ — **Blast Furnace RESTORED to main 2026-09-12** by The Guns of Asgarnia (`content/minigames/blastfurnace/`, portal row, wiki). PR #341 (and GotR #340) merged into the stacked `pvm/12-guardians-of-the-rift` branch, never into `main`; GotR is still absent |
