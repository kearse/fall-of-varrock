...
| Sir Amik: "I have an army. I do not have an army to spare." + the three pressures + Tiffy | **Sir Amik Varze** 4771 @ 2960,3336,2 (world spawn) | `bindTalk` + `NpcTalk` | step `amik` — `talk(AMIK, "amik")` → `amikMeeting` |
