# Discord Listing Copy — Fall of Varrock
...
copy. Swap `discord.gg/YOURINVITE` and `fallofvarrock.com` for the real links
before posting.

---

## Card description (short blurb)

The one- or two-line hook shown on the server card / in search results. Pick the
variant that fits each site's character limit.

**~100 chars (tight limits, e.g. Disboard tagline):**
...
## Page description (full listing)

Long-form copy for the server's dedicated listing page. Uses emoji section
headers and short scannable bullets — the format that performs on RSPS listings.
Markdown renders on Discadia/top.gg; on Disboard it degrades gracefully to plain
text with emojis and line breaks.

---

⚔️ **FALL OF VARROCK** — a custom Old School RuneScape server (revision 228)
...
the world: Peasant → Commoner → Squire → Soldier → Knight → **Lord → Minister → King**.
Rank sets the armour you may wear *and* the war you may command. Outrank an enemy and
lesser foes stop bothering you.

**🏰 Command the war (the endgame)**
Every city beyond Lumbridge has fallen. Band together and take them back:
• **Lord+** summon bosses and lead raid parties
• **Minister+** launch campaigns on Varrock
...
they hit harder, gear them from your own bank, and revive them with every level and item
...
👉 **Join the Discord:** discord.gg/YOURINVITE

*Spawn in Lumbridge. Earn your rank. March to war.*
...
- **Trim for the platform.** Disboard's bump description favours shorter blocks; keep the
  top three feature sections and the CTA if you need to cut. Discadia/top.gg can take the
  whole thing.
