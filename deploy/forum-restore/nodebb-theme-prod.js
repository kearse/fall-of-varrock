...
//
// PROD copy: section cids are substituted by restore-forum.sh (__CID_*__ placeholders)
// because prod cids differ from the dev install.
var CSS = [
...
/* Custom section icons: swap the FontAwesome square for the Fall of Varrock art (served same-origin from NodeBB uploads). */
'li.category-__CID_OFFICIAL__ span.icon,li.category-__CID_GENERAL__ span.icon,li.category-__CID_WAR__ span.icon,li.category-__CID_MEDIA__ span.icon,li.category-__CID_SUPPORT__ span.icon{background-color:transparent!important;background-size:contain!important;background-repeat:no-repeat!important;background-position:center!important;width:2.75rem!important;height:2.75rem!important}',
'li.category-__CID_OFFICIAL__ span.icon>i,li.category-__CID_GENERAL__ span.icon>i,li.category-__CID_WAR__ span.icon>i,li.category-__CID_MEDIA__ span.icon>i,li.category-__CID_SUPPORT__ span.icon>i{display:none!important}',
'li.category-__CID_OFFICIAL__ span.icon{background-image:url(/assets/uploads/fov/official.png)!important}',
'li.category-__CID_GENERAL__ span.icon{background-image:url(/assets/uploads/fov/general.png)!important}',
'li.category-__CID_WAR__ span.icon{background-image:url(/assets/uploads/fov/war.png)!important}',
'li.category-__CID_MEDIA__ span.icon{background-image:url(/assets/uploads/fov/media.png)!important}',
'li.category-__CID_SUPPORT__ span.icon{background-image:url(/assets/uploads/fov/support.png)!important}'
].join('');
